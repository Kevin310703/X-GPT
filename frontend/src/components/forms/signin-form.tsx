...
export function SigninForm() {
    ...
    return (
        <div className="w-full max-w-md mt-10 relative">
            {/* Back to Home Link */}
            <Link href="/"
                className="absolute top-[-40px] left-0 text-gray-600 hover:text-indigo-600 transition-colors mb-4">
                ← Back to Home
            </Link>
            ...
            <form action={formAction}>
                <Card>
                    <CardHeader className="space-y-1 text-center">
                        <CardTitle className="text-3xl font-bold py-2">Sign In</CardTitle>
                        <CardDescription>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2 text-sm text-right">
                            <Link href="/auth/forgotpassword" className="font-bold bg-gradient-to-r from-[#4A25E1] to-[#7B5AFF] 
                            bg-clip-text text-transparent hover:text-violet-900">
                                Forgot Password?
                            </Link>
                        </div>
                    </CardContent>
                ...
                <div className="mt-4 text-center text-sm">
                    ...
                    <Link className="font-bold bg-gradient-to-r from-[#4A25E1] to-[#7B5AFF] bg-clip-text 
